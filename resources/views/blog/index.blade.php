        ...
        <div class="card-body">
          ...
          <form action="{{ route('blog.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-9">
                <input type="text" class="form-control" name="long_description" id="long_description" placeholder="Long Description...">
              </div>
            </div>
            ...
            <div class="row md-3">
              ...
              <div class="col-md-9">
                ...
                <input type="submit" class="btn btn-sm btn-success" value="Add Blog">
              </div>
            </div>
